...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/spfvalidator',
        'Source': 'https://github.com/apiverve/spfvalidator-api',
        'Bug Tracker': 'https://github.com/apiverve/spfvalidator-api/issues'
    },
    classifiers=[
